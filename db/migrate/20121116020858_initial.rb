...
pk('types', 'name')
  ...
  create_table "pack_cards", :id => false do |t|
  ...
  pk('deck_cards', 'deck_id', 'card_code')
  fk('deck_cards', 'card_code', 'cards', 'code')
  fk('deck_cards', 'deck_id', 'decks', 'id')
